        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a href="index.php" class="nav-link smoothScroll">Logowanie</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="containerh">
  ...
  <div class="overlayh"><h2>Click - Rejestracja</h2>
</div>
</div>
    ...
    <section class="about section-padding col-md-4 offset-md-4" id="about">
					...
					<form class="login100-form validate-form" action="action\add_register.php" method="post">
...
<div class='col-md-10 offset-md-1'>
					<div class="wrap-input100 validate-input m-t-10 m-b-25" data-validate = "Login">
						<input class="input100" type="text" name="username" placeholder="Login">
					</div>

    <div class="wrap-input100 validate-input m-t-10 m-b-25" data-validate = "Imię i Nazwisko">
        <input class="input100" type="text" name="name" placeholder="Imię i Nazwisko">
    </div>


    <div class="wrap-input100 validate-input m-b-25" data-validate="Hasło">
						<input class="input100" type="password" name="password" placeholder="Hasło">
					</div>

    <div class="wrap-input100 validate-input m-b-25" data-validate="Numer Telefonu">
        <input class="input100" type="text" name="phone" placeholder="Numer Telefonu">
    </div>
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <form action="#" method="get" class="contact-form webform"  role="form">
                        ...
                        <div class="form-group d-flex flex-column-reverse">
                            ...
                            <label for="cf-email" class="webform-label">Dane kontaktowe</label>
                        </div>
