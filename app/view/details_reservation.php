...
<a href="../action/reject.php?id=<?php echo $table['id'];?> " class="btn btn-danger form-control col-md-4 offset-md-4   " style="margin-bottom: 5px; margin-top: 20px;">Usuń rezerwacje</a>
