...
<input type="text" class="form-control"  placeholder="Identyfikator rezerwacji" name="id" required>
</div>
...
<button type="submit" class="btn btn-secondary form-control col-md-3 offset-md-3  " style="margin-bottom: 5px; margin-top: 20px;">Wyszukaj</button>&nbsp;
</form><br>
<a class="btn btn-secondary form-control col-md-3" data-toggle="modal" data-target="#exampleModal" style="margin-bottom: 20px; margin-top: 20px; color: white">Dodaj</a>
	...
	<tr class="table-secondary">
		...
		<th style="text-align: center">Do rezerwacji</th>
		...
		$query = "SELECT * FROM services";
            ...
            else
            {
                        ...
                        $id = $_POST['id'];
						{
									...
									$query = "SELECT * FROM services WHERE id_reservation like $id ";
...
$result = $db->query($query);
                 ...
                 <td><a class=\"btn btn-outline-secondary \" href='details_reservation.php?id=".$table['id_reservation']."' \">Do rezerwacji</a></td>";
                 echo "<td><a class=\"btn btn-outline-secondary \" href='../action/del_services.php?id=".$table['id']."' \">Usuń</a></td>";
